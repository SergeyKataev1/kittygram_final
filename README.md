...
запрос списка котиков
http://{ваш домен}/api/cats/
запрос списка достижений
http://{ваш домен}/api/achievements/
---
...
* [Sergey Kataev(Backend)](https://github.com/sergeykataev1)
